...
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.StudentViewer> {
    ...
    public class StudentViewer extends RecyclerView.ViewHolder {
        ...
        public StudentViewer(View itemView) {
            super(itemView);
            pID = itemView.findViewById(R.id.txt_id);
            pIdno = itemView.findViewById(R.id.txt_idno);
            pName = itemView.findViewById(R.id.txt_name);
            pAddress = itemView.findViewById(R.id.txt_address);
